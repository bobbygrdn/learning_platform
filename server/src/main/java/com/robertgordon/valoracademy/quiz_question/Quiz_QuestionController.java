...
public class Quiz_QuestionController {
     ...
     * injection. In this code, it is used to inject instances of Quiz_QuestionService` 
     ...
     * @param quizId The ID of the quiz to which the question is being added.
     * @param quiz_questionRequest The request body containing the details of the 
     * Quiz_Question object to be created.
     * @return A ResponseEntity object containing a Quiz_Question object is being returned.
     */
    ...
    */
    ...
    /**
     * This method retrieves a quiz question by its ID and returns it as a ResponseEntity.
     * @param quiz_questionId The parameter "quiz_questionId" is a Long variable that 
     * represents the ID of a quiz question. It is annotated with @PathVariable, which 
     * means that its value is extracted from the URL path of the HTTP request. This 
     * method returns a ResponseEntity object that contains the Quiz_Question object 
     * with the specified ID
     * @return A ResponseEntity object containing a Quiz_Question object with the specified
     * quiz_questionId.
     */
    ...
    /**
     * This method updates a quiz question with the given ID and returns the updated question.
     * @param quiz_questionId The ID of the quiz question that needs to be updated.
     * @param quiz_question The updated Quiz_Question object that will replace the existing Quiz_Question object with the specified quiz_questionId.
