...
public class QuizServiceImpl implements QuizService {
     ...
     * information about a quiz. This method saves the quiz object to the database 
     * using the quizRepository. The @Override annotation indicates that this method 
     ...
     * identifier of a quiz that needs to be retrieved from the database.
     ...
     * contains the updated information for an existing quiz. It is used to update 
