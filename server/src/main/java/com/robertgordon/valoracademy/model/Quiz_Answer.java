 ...
 * `@Table(name = "answers")` specifies the name of the table in the database that
...
public class Quiz_Answer {
     ...
     *  the database. 
     * `private long id;` is a field that represents the primary key 
     *  of the entity. */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    /** `@Column(name = "content", nullable = false)` is an annotation used to specify that the `content`
