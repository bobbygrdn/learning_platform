...
public class UserController {
     ...
     * received as a request body in a POST request to the "/users" endpoint. 
     * The method "saveUser" of the controller class takes this user object as input,
    ...
    /**
     * This method retrieves a user by their ID and returns a ResponseEntity containing 
     * the user object.
     * @param userId The userId is a path variable that is extracted from the URL of 
     * the GET request. It represents the unique identifier of the user that the client
     *  is requesting to retrieve from the server.
     * @return A ResponseEntity object containing a User object with the specified userId.
     */
    @GetMapping("users/{id}")
   ...
   /**
    * This method updates a user with the given ID and returns the updated user as a 
    * ResponseEntity.
    * @param id The ID of the user that needs to be updated. It is passed as a path 
    * variable in the URL.
    * @param user The user parameter is a request body that contains the updated 
    * information for the user that needs to be updated in the database. It is sent 
    * as a JSON object in the request body.
    * @return A ResponseEntity object containing the updated User object is being returned.
    */
    @PutMapping("users/{id}")
     ...
     * updated user.
     * @param id The ID of the user whose role needs to be updated. It is extracted 
     * from the URL path using the @PathVariable annotation.
     * @param user The user parameter is a request body that contains the updated 
     * information for the user whose role is being updated. It is of type User, 
     * which is a custom class representing a user in the system. The user object 
     * contains properties such as name, email, password, and role.
     * @return A ResponseEntity object containing the updated User object with the specified ID.
     */
    ...
    /**
     * This method deletes a user with a specific ID and returns a message confirming the deletion.
     * @param id The id parameter is a Long type variable that represents the unique 
     * identifier of a user that needs to be deleted. It is obtained from the URL path 
