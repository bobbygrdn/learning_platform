...
| 07/03/2023 | - Created the catalog page for the user to be able to view all the current courses and enroll in a course <br> - Updated the profile page for password reset and account deletion | - Users can click on a course and see its information and enroll in the course if they choose <br> - Profile page now has the updated logic to allow for the user to reset their password and delete their account | 95% |
