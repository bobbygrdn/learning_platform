...
| 06/26/2023 | - Updated the logic in the publisher view of the admin dashboard to reflect the real time preview of the user <br> - Changed the dummy data for the courses to reflect the real time data | - The content now gets rendered as html tags instead of plain text. <br> - The Courses now reflect the correct structure of the platform. There are 4 courses total. | 87% |
